...
function Node(parent, callback) {
  ...
  this.startAllServices(function() {
    ...
    console.info('[mock-srv]   capi> raw:' + self.capiSvc.port + ', ssl:' + self.capiSvc.sslPort);
    console.info('[mock-srv]   mgmt> raw:' + self.mgmtSvc.port + ', ssl:' + self.mgmtSvc.sslPort);
    console.info('[mock-srv]   memd> raw:' + self.memdSvc.port + ', ssl:' + self.memdSvc.sslPort);
    console.info('[mock-srv]   n1ql> raw:' + self.n1qlSvc.port + ', ssl:' + self.n1qlSvc.sslPort);
